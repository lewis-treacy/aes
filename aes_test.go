...
var test_Cypher1 Cypher = Cypher{
	[]byte{
...
var test_Cypher2 Cypher = Cypher{
	[]byte{
...
var test_Cypher3 Cypher = Cypher{
	[]byte{
...
func Test_Encrypt(t *testing.T) {
	for _, c := range []struct {
		...
		{&test_Cypher2, []byte("Hello World!"), []byte{
			0xD4, 0x82, 0xD4, 0x20, 0xAA, 0x67, 0xEA, 0x43,
			0x5D, 0xAF, 0xB6, 0xF4, 0x6E, 0x54, 0xAA, 0x2A,
		}, false},

		{&test_Cypher3, []byte("This is a super secret message and thus requires a 256 bit key"), []byte{
